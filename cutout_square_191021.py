...
hdulist = fits.open('./'+cluster_list[l]+'_5500_mf_large_selfcal_cgcurs_161111.fits')      #========================================================================HERE
#hdulist = fits.open('./'+cluster_list[l]+'_5500_noise_map.fits')      #========================================================================HERE
...
print scidata_flux.shape

hdu = fits.PrimaryHDU(scidata_flux[0,0,1042:1242, 2406:2606], header=header_flux)  #[0,0, xxx, xxx] for flux map!!!!
hdul = fits.HDUList([hdu])

hdul.writeto('./'+cluster_list[l]+'_crop_sqaure_small.fits')
#hdul.writeto('./'+cluster_list[l]+'_crop_rms_sqaure_small.fits')
